  ...
  return (
    <div className='bg-image w-screen h-screen flex justify-center items-center p-10'>
      ...
      <div className='w-1/2 h-[90%] flex flex-col justify-center items-center  '>
        ...
        <form className='flex flex-col gap-4 w-3/4' onSubmit={handleSubmit(RegisterHandler)}>
        <input 
            type="text"
     ...
     <div className= '  w-1/2 h-[90%]   flex flex-col justify-center items-center p-5 gap-5  '>
        <DotLottieReact 
          ...
          autoplay
        />
        <p className='text-center text-white mb-10'>All Ready A Member? <NavLink to="/login" className='text-blue-500'>Login Here!</NavLink></p>
     </div>
     </div>
    </div>
  )
