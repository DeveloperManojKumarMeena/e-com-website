    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-gray-900 via-black to-gray-800 flex justify-center items-center px-4">
      <div className="glassmorphism w-full max-w-5xl h-[90vh] rounded-3xl flex overflow-hidden shadow-2xl border border-gray-800">
        ...
        <div className="w-1/2 bg-black/30 backdrop-blur-lg flex flex-col justify-center items-center px-10">
          <h1 className="text-4xl font-bold text-white mb-6 tracking-wide">Create Account</h1>
          <p className="text-gray-400 mb-8">Join us and explore more</p>

          <form onSubmit={handleSubmit(RegisterHandler)} className="w-full flex flex-col gap-5">
            <input type="text" placeholder="User Name" {...register("UserName", { required: true })}
              className="p-3 rounded-lg bg-white/10 border border-gray-600 text-white placeholder-gray-400 outline-none focus:border-green-500 transition"
            />
            ...
            <button className="bg-green-600 hover:bg-green-700 text-white py-3 rounded-lg shadow-lg transition">
              Register
            </button>
          </form>
        ...
        {/* Right */}
        <div className="w-1/2 flex flex-col justify-center items-center bg-gradient-to-br from-green-900 to-emerald-700 text-white">
          <DotLottieReact
            ...
            className="w-80"
          />
          <p className="mt-6 text-lg">Already have an account?</p>
          <NavLink to="/login" className="text-green-300 font-semibold hover:text-white underline transition">
            Login Here
          </NavLink>
        </div>
      </div>
